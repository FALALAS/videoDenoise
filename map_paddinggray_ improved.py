...
output_folder = '0001clean_paddinggray5_var2500'
...
for frame_number in range(1, num_images):
    ...
    for x in range(0, padding_h - win_size + 1):
        ...
        for y in range(0, padding_w - win_size + 1):
            ...
            aligned_window = aligned_frame_gray[x: x + win_size, y: y + win_size]
    ...
    print(f"已处理到第 {frame_number} 帧，用时 {elapsed_time:.2f}")
