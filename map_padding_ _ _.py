...
for frame_number in range(1, num_images):
    ...
    current_frame_gray = cv2.copyMakeBorder(current_frame_gray, padding_width, padding_width, padding_width, padding_width,
                                       cv2.BORDER_CONSTANT, value=0)
    aligned_frame_gray = cv2.copyMakeBorder(aligned_frame_gray, padding_width, padding_width, padding_width, padding_width,
                                       cv2.BORDER_CONSTANT, value=0)
